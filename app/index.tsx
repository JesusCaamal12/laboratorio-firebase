...
import { insertarUsuario } from '../database/db'; // Ajusta la ruta si es diferente
...
export default function Login() {
  ...
  const login = async () => {
    ...
    try {
      await insertarUsuario(email, password); // Usamos Firestore para guardar el usuario
      router.replace('/login'); // Redirige al index después de crear el usuario
    } catch (error) {
